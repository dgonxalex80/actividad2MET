...
La Actividad 2 está compuesta por tres problemas planteados, dos de ellos basados en la simulación y un tercero en lectura de dos artículos que se describen a continuación:
...
A continuación se describen los siguientes pasos para si verificación:
...
b. Genere una función que: 
    * Permita obtener una muestra aleatoria de la población y 
    * Calcule el estimador de la proporción muestral $\widehat{p}$ para un tamaño de muestra dado $n$. 

</br>

c. Repita el escenario anterior (b) $n=500$ veces y analice los resultados en cuanto al comportamiento de los $500$ resultados del estimador $\widehat{p}$. ¿Qué tan simétricos o sesgados son los resultados obtenidos? y ¿qué se puede observar en cuanto a la variabilidad?. Realice un comentario sobre los resultados obtenidos.

</br>

d. Repita los puntos  b y c para tamaños de muestra $n=5$, $10$, $15$, $20$, $30$, $50$, $60$, $100$, $200$, $500$. Compare los resultados obtenidos para los diferentes tamaños de muestra en cuanto a la normalidad. Utilice pruebas de bondad y ajuste (shapiro wilks) y métodos gráficos (grafico qqnorm de normalidad). Comente los resultados obtenidos

</br>

e. Repita toda la simulación (puntos a – d), pero ahora para lotes con 10% de plantas enfermas y de nuevo para lotes con un 90% de plantas enfermas. Concluya sobrelos resultados del ejercicio.
...
Escriba un resumen (máximo 2 páginas) sobre ambos artículos e incluya en este sus opiniones en cuanto al uso del valor p como criterio de decisión en inferencia estadística.
